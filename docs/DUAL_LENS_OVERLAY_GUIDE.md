...
**Summary:** Emphasizes rigorous research, mechanisms, and replication.

**How It Works**

- **Base Seeds**: compounds.txt, targets.txt, models.txt, assays.json, etc.
- **Overlays**: science_research_v1 ranking rules and seed emphasis.
...
**Summary:** Emphasizes protocols, stacks, and self-experimentation.
