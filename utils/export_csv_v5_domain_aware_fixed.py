...
# Import modules at module level for performance
...
from utils.export_utilities import safe_confidence_boost, count_entities_by_role, get_domain_info, load_overlay_aliases_safe

DB_PATH = Path("runs") / "all_pdfs_combined.sqlite"
...
def export_events_domain_aware(domain_id: str = None):
    ...
    with open(events_path, 'w', newline='', encoding='utf-8') as f:
        ...
        for event in events:
            ...
            conf_orig_normalized = conf_orig.lower().strip() if conf_orig else "low"
